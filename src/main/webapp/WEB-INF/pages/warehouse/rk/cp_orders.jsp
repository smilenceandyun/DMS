...
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="0">&nbsp;&nbsp;&nbsp;<a href="/pur_incp/add" class="btn btn-success radius"><i class="Hui-iconfont">&#xe600;</i> 添加订单</a></span> <span class="r">共有数据：<strong>0</strong> 条</span> </div>
    ...
    <form:form action="/index3" method="post" commondName="p">
        ...
        <table class="table table-border table-bordered table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <th width="30">ID</th>
                    <%--<th width="80">排序</th>--%>
                <th width="100">产品入库单号</th>
                <th width="100">供货商</th>
                <th width="80">生产核算单号</th>
                <th width="80">入仓日期</th>
                <th width="80">业务属性</th>
                <th width="80">业务员</th>
                <th width="80">制单人</th>
            ...
            <c:forEach items="" var="bSOrder">
                <tr class="text-c">
                    ...
                    <td class="f-14 product-brand-manage"><c:if test="${bSOrder.bSOrderMState == \"0\"}"><a style="text-decoration:none" onClick="product_brand_edit('订单编辑','index2.html','1')" href="/updateMcpin" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a></c:if><a style="text-decoration:none" class="ml-5" onclick="if(!confirm('确定删除？')) return false;" href="" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
