...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 仓库管理 <span class="c-gray en">&gt;</span> 借用入库明细 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    ...
    <div class="mt-20">
        ...
        <form:form id="detail" name="detail" action="/pur_injy/detaileOrder/addP" method="post" role="form" >
        ...
        <div id="p2">
            <ul>
                ...
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;厂家编码</li>
                <li>
                    <input  class="input-text"  onchange="goodsChange(this.value);" name="bSOrderSGoodsNo" required>
                </li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;赠送性质</li>
        ...
        <table class="table table-border table-bordered table-bg table-sort">
            ...
            <c:forEach items="${bSOrderS}" var="bSOrderS">
                <tr  class="text-c" >
                    ...
                    <td class="f-14 product-brand-manage"><a style="text-decoration:none" onClick="product_brand_edit('明细编辑','index2.html','1')" href="/pur_injy/detaileOrder/update" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" onclick="if(!confirm('确定删除？')) return false;" href="/sale_order/detaileOrder/delete/${bSOrderS.bSOrderSDetailId}&${bSOrderS.bSOrderSSOrderNo}" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
