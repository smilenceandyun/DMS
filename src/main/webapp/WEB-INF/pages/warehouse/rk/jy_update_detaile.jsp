...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 仓库管理 <span class="c-gray en">&gt;</span> 更新明细 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">

    <div class="mt-20">
        <form:form action="/pur_injy/detaileOrder/updateP" method="post" role="form">
            <ul>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;借用入库单号</li>
            ...
            <div style="width: 900px">
                <center>
                    ...
                    <a href="/pur_injy/detaileOrder"  class="btn btn radius">取消</a>
                </center>
            </div>
        </form:form>
