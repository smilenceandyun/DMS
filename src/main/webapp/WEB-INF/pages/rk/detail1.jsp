            ...
            <table class="table table-border table-bordered table-bg table-sort">
                ...
                <c:forEach items="${procures}" var="item">
                    <tr class="text-c">
                        ...
                        <c:if test="${mpur.bProcureMState == null}">
                        <td class="f-14 product-brand-manage"><a style="text-decoration:none"  href="/procure/detailone/${item.bProcureSProcureNo}&${item.bProcureSDetailId}" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a> <a style="text-decoration:none" class="ml-5" href="/procure/deteleDetail/${item.bProcureSProcureNo}&${item.bProcureSDetailId}" onclick="if(!confirm('确定删除？')) return false;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
                        </c:if>
                    </tr>
                </c:forEach>
                </tbody>
