        ...
        function goodsChange(id) {
            switch (id){
                ...
                case "${good.tGoodsGoodsNo}":
                    document.getElementById("d5").value = "${good.tGoodsGoodsSpce}";
                    document.getElementById("d7").value = "${good.tGoodsBarcode}";
                    document.getElementById("d8").value = "${good.tGoodsGoodsName}";
                    document.getElementById("d9").value = "${good.tGoodsUnit}";
                    document.getElementById("d11").value = "${good.tGoodsExDay}";
                    break;
                </c:forEach>
            }
        }
...
<div class="page-container">
    ...
    <ul>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;订单货号</li>
        <li><input required readonly id="d1" type="text" class="input-text" value="${procure.bPurchaseOrdMByBProcureMOrdProcureNo.bPurchaseOrdMOrdProcureNo}" name="ordProcureNo"></li>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;厂家编码</li>
        <li><input required id="d2" type="text" class="input-text" value="${procure.bPurchaseOrdMByBProcureMOrdProcureNo.bPurchaseOrdMFactoryGoodsNo}" name=""></li>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;赠送性质</li>
    ...
    <ul>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;商品条码</li>
        <li><input required id="d7" type="text" class="input-text" name=""></li>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;商品名称</li>
        <li><input required id="d8" type="text" class="input-text" name=""></li>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;单位</li>
        <li><input required id="d9" type="text" class="input-text" name=""></li>
    </ul><br>
    <ul>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;仓库编号</li>
        <li>
