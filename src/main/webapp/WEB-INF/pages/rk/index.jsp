...
<div class="page-container">
    <%--<div class="text-c">--%>
        ...
        <%--</form>--%>
    <%--</div>--%>
    <div class="cl pd-5 bg-1 bk-gray mt-20">  <span style="margin-left: 10px"><a href="/procure/add" onclick="" class="btn btn-success radius"><i class="Hui-iconfont">&#xe600;</i> 新增单据</a></span> <span class="r">共有数据：<strong>${list.size()}</strong> 条</span> </div>
