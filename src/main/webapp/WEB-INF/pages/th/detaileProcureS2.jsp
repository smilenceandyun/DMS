...
<div class="page-container">
    ...
    <div class="mt-20">
        ...
        <c:if test="${!empty brProcureS}">
            ...
            <ul>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;商品名称</li>
                <li><input type="text" class="input-text" readonly="readonly" name="" value="${detail.bPurchaseOrdS.tGoodsByBPurchaseOrdSGoodsNo.tGoodsGoodsName}"></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;商品条码</li>
                <li><input type="text" class="input-text" readonly="readonly" name="" value="${detail.bPurchaseOrdS.tGoodsByBPurchaseOrdSGoodsNo.tGoodsBarcode}"></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;商品编码</li>
                <li><input type="text" class="input-text" readonly="readonly" name="" value="${detail.bPurchaseOrdS.tGoodsByBPurchaseOrdSGoodsNo.tGoodsGoodsNo}"></li>
            </ul><br>
            <ul>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;退货单号</li>
                <li><input type="text" class="input-text" readonly="readonly" name="" value="${brProcureNo}" ></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;规格型号</li>
                <li><input type="text" class="input-text" readonly="readonly" name="" value="${detail.bPurchaseOrdS.tGoodsByBPurchaseOrdSGoodsNo.tGoodsGoodsSpce}"></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;仓库</li>
                <li><input type="text" class="input-text" readonly="readonly" name="" value="${detail.bPurchaseOrdS.tRoomByBPurchaseOrdSRoomNo.tRoomRoomName}" ></li>
            </ul><br>
            <ul>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;基本数量/单位</li>
                <li><input type="text" class="input-text" readonly="readonly" name="" value="${detail.bPurchaseOrdS.bPurchaseOrdSQuantity}${detail.bPurchaseOrdS.tGoodsByBPurchaseOrdSGoodsNo.tGoodsUnit}" ></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;包装数量/单位</li>
                <li><input type="text" class="input-text" readonly="readonly" name="" value="${detail.bPurchaseOrdS.bPurchaseOrdSBoxQuantity}${detail.bPurchaseOrdS.tGoodsByBPurchaseOrdSGoodsNo.tGoodsPackUnit}" ></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;税率</li>
                <li><input type="text" class="input-text" readonly="readonly" name="" value="${detail.bPurchaseOrdS.bPurchaseOrdSTaxRate}" ></li>
            </ul><br>
            <ul>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;厂家编码</li>
                <li><input type="text" class="input-text" readonly="readonly" name="" value="${detail.bPurchaseOrdS.bPurchaseOrdSFactoryGoodsNo}" ></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;库位编号</li>
                <li><input type="text" class="input-text" readonly="readonly" name="taxRate" value="${detail.bRProcureSLocationNo}" ></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;保质期/月</li>
                <li><input type="text" class="input-text" readonly="readonly" name="" value="${detail.bPurchaseOrdS.tGoodsByBPurchaseOrdSGoodsNo.tGoodsExDay/30}" ></li>
            </ul><br>
            <ul>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;生产日期</li>
                <li><input type="text" class="input-text" readonly="readonly" name="" value="${detail.bPurchaseOrdS.bPurchaseOrdSMfg}"></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;交易原价</li>
                <li><input type="text" class="input-text" readonly="readonly" name="" value="${detail.bPurchaseOrdS.bPurchaseOrdSOriginalPrice}"></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;批次号</li>
                <li><input type="text" class="input-text" readonly="readonly" name="price" value="${detail.bPurchaseOrdS.bPurchaseOrdSLot}"></li>

            </ul><br>
            <%--<ul>--%>
                <%--<li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;备注</li>--%>
                <%--<li style="float: left;width: 390px;"><input type="text" class="input-text" id="bPurchaseOrdMNotes" name="bPurchaseOrdMNotes" value=""></li>--%>
            <%--</ul><br>--%>
