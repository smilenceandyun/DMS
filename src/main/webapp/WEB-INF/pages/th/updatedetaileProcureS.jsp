        ...
        <form:form id="detail" name="detail" action="/th/detail/addP" method="post" role="form" >
            <ul>
                ...
                <li><select id="good1" class="input-text" required onchange="goodsChange(this.value);" name="bRProcureSGoodsNo" required>
                    <option value="${brProcureSEntity.bRProcureSGoodsNo}" selected>修改前商品编号${brProcureSEntity.bRProcureSGoodsNo}</option>
                    <c:forEach items="${bPurchaseOrdSEntities}" var="bPurchaseOrdSEntities">
            ...
            <ul>
                ...
                <li>
                    <select class="input-text" required onchange="caigou(this.value);" id="bRProcureSOrdProcureNo" name="bRProcureSOrdProcureNo" required>
                        <option value="${brProcureSEntity.bRProcureSOrdProcureNo}" selected >修改前采购订单号${brProcureSEntity.bRProcureSOrdProcureNo}</option>
                        <c:forEach items="${bPurchaseOrdSEntities}" var="bPurchaseOrdSEntities">
                            <option value="${bPurchaseOrdSEntities.bPurchaseOrdSOrdProcureNo}">${bPurchaseOrdSEntities.bPurchaseOrdSOrdProcureNo}</option>
                        </c:forEach>
                ...
                <li>
                    <select class="input-text" name="bRProcureSRoomNo" id="bRProcureSRoomNo" required>
                        <option value="${brProcureSEntity.bRProcureSRoomNo}" >修改前仓库编号${brProcureSEntity.bRProcureSRoomNo}</option>
            ...
            <ul>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;数量/单位</li>
                <li><input type="text" class="input-text" readonly="readonly" id="shuliang" name="bRProcureSQuantity" value="${brProcureSEntity.bRProcureSQuantity}" ></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱数</li>
                <li><input type="text" class="input-text"  name="bRProcureSBoxQuantity" id="bRProcureSBoxQuantity" value="${brProcureSEntity.bRProcureSBoxQuantity}"></li>
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;税率</li>
            ...
            <ul>
                ...
                <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;批次号</li>
                <li><input type="text" class="input-text" readonly="readonly" name="price" value="${brProcureSEntity.bPurchaseOrdS.bPurchaseOrdSLot}"></li>

            </ul><br>

            <br>
            <center>
                <input class="btn btn-primary upload-btn" type="submit" name="submit" value="确认修改">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
