    ...
    <form:form action="/index3" method="post" commondName="p">
        ...
        <table class="table table-border table-bordered table-bg table-sort">
            ...
            <%
                int i = 1;
            %>
            <c:forEach items="${bSOrder}" var="bSOrder">
                <tr class="text-c">
                    ...
                    <td class="f-14 product-brand-manage"><c:if test="${bSOrder.bSOrderMState == \"0\"}"><a style="text-decoration:none" onClick="product_brand_edit('订单编辑','index2.html','1')" href="/updateMa/${bSOrder.bSOrderMSOrderNo}" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a></c:if><a style="text-decoration:none" class="ml-5" onclick="if(!confirm('确定删除？')) return false;" href="/sale_order/delete/${bSOrder.bSOrderMSOrderNo}" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
