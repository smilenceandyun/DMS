...
<div class="page-container">
    <ul>
        ...
        <li><input disabled id="d1" value="${pro.promotionMProductSPromotionNo}" type="text" class="input-text" name="ordProcureNo"></li>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;商品名称</li>
        <li><input id="d2" type="text" value="${pro.tGoodsByPromotionMProductSGoodsNo.tGoodsGoodsName}" class="input-text" name=""></li>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;促销价格</li>
        <li><input id="d3" type="text" class="input-text" value="${pro.tGoodsByPromotionMProductSGoodsNo.tGoodsInPrice}" name=""></li>
    </ul><br>
    <ul>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;主商品条码</li>
        <li><input id="d4" type="text" class="input-text" value="${pro.tGoodsByPromotionMProductSGoodsNo.tGoodsBarcode}" name=""></li>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;厂家编码</li>
        <li><input id="d5" type="text" class="input-text" value="${pro.tGoodsByPromotionMProductSGoodsNo.tGoodsFactoryGoodsNo}" name=""></li>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;合同价格</li>
        <li><input id="d6" type="text" class="input-text" value="${pro.tGoodsByPromotionMProductSGoodsNo.tGoodsSPrice}" name=""></li>
    </ul><br>
    <ul>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;主商品编号</li>
        <li><input id="d7" type="text" class="input-text" value="${pro.promotionMProductSGoodsNo}" name=""></li>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;仓库</li>
        <li><input id="d8" type="text" class="input-text" value="${pro.storeLocationByPromotionMProductSLocationNo.tRoomByStoreLocationRoomNo.tRoomRoomName}" name=""></li>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;合同箱价</li>
        <li><input  id="d9" type="text" class="input-text" value="${pro.tGoodsByPromotionMProductSGoodsNo.tGoodsSPrice}" name=""></li>
    </ul><br>
    <ul>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;商品条码</li>
        <li><input id="d10" type="text" class="input-text" value="${pro.tGoodsByPromotionMProductSGoodsNo.tGoodsBarcode}" name=""></li>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;单位</li>
        <li><input  id="d11" type="text" class="input-text" value="${pro.tGoodsByPromotionMProductSGoodsNo.tGoodsUnit}" name=""></li>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;促销金额</li>
        <li><input id="d12" type="text" class="input-text" value="${pro.tGoodsByPromotionMProductSGoodsNo.tGoodsInPrice * 20}" name=""></li>
    </ul><br>
    <ul>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;商品编码</li>
        <li><input id="d13" type="text" class="input-text" value="${pro.promotionMProductSGoodsNo}" name=""></li>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;包装税率</li>
        <li><input  id="d14" type="text" class="input-text" value="${pro.tGoodsByPromotionMProductSGoodsNo.tGoodsInTax}" name=""></li>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;结算方式</li>
        <li><input id="d15" type="text" class="input-text" value="整单结算" name=""></li>
    </ul><br>
    <ul>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;备注</li>
        <li><input style="width: 390px;" id="d16" type="text" value="${pro.promotionMByPromotionMProductSPromotionNo.promotionMNotes}" class="input-text" name=""></li>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
        <li></li>
        <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;赠送性质</li>
