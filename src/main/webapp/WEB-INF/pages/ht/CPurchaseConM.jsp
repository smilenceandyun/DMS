...
<div class="page-container">
    <%--<div class="text-c">--%>
        ...
        <%--</form>--%>
    <%--</div>--%>
    <div class="cl pd-5 bg-1 bk-gray mt-20"><span class="l">&nbsp;&nbsp;&nbsp;<a href="/add" class="btn btn-success radius"><i class="Hui-iconfont">&#xe600;</i> 添加订单</a></span> <span class="r">共有数据：<strong>1</strong> 条</span> </div>
        ...
        <form:form action="/index3" method="post" commondName="p">
            ...
            <table class="table table-border table-bordered table-bg table-sort">
                ...
                <%
                    int i = 1;
                %>
                <c:forEach items="${cPurchaseConM}" var="cPurchaseConM">
                    <tr class="text-c">
                        <td><input name="id" type="checkbox" value="${cPurchaseConM.cPurchaseConMPurchasConNo}"></td>
                        <td><%=i %><% i++; %></td>
                        ...
                        <td class="f-14 product-brand-manage"><c:if test="${cPurchaseConM.cPurchaseConMState == \"0\"}"><a style="text-decoration:none" onClick="product_brand_edit('订单编辑','index2.html','1')" href="/updateM/${cPurchaseConM.cPurchaseConMPurchasConNo}" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a></c:if><a style="text-decoration:none" class="ml-5" onclick="if(!confirm('确定删除？')) return false;" href="/deleteM/${cPurchaseConM.cPurchaseConMPurchasConNo}" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
                </c:forEach>
                </tbody>
            </table>
        </form:form>
