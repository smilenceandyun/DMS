...
<div class="page-container">
    <div class="mt-20">
        ...
        <ul>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;商品名称</li>
            <li><input type="text" class="input-text" name="" value="#商品名称${detail.cPurchaseConSDetailId}"></li>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;厂家编码</li>
        ...
        <ul>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;商品条码</li>
            <li><input type="text" class="input-text" name="" value="#商品条码${detail.cPurchaseConSDetailId}"></li>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱价</li>
        ...
        <ul>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;商品编码</li>
            <li><input type="text" class="input-text" name="" value="#商品编码${detail.cPurchaseConSDetailId}" ></li>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;单位</li>
            <li><input type="text" class="input-text" name="" value="#单位${detail.cPurchaseConSDetailId}"></li>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;规格型号</li>
            <li><input type="text" class="input-text" name="" value="#规格型号${detail.cPurchaseConSDetailId}"></li>
        </ul><br>
        <ul>
            <li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;合同编号</li>
