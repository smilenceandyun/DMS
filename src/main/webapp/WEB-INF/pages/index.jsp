...
<head>
    ...
    <![endif]-->
    <title>东万晟物流</title>
    <meta name="keywords" content="DMS物流管理系统">
    <meta name="description" content="东万晟有限公司">

</head>
<body>
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="index3">DMS物流管理系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="index3">DMS</a>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    ...
                    <li><a data-href="BRProM_order" data-title="采购退货" href="javascript:void(0)">采购退货</a></li>
                    <li><a data-href="promotion" data-title="采购协议" href="javascript:void(0)">采购协议</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-picture">
        ...
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    <li><a data-href="pur_order" data-title="报表管理" href="javascript:void(0)">报表管理</a></li>
                    <li><a data-href="pur_order" data-title="报表管理" href="javascript:void(0)">报表管理</a></li>
                    <li><a data-href="pur_order" data-title="报表管理" href="javascript:void(0)">报表管理</a></li>
                </ul>
            </dd>
        ...
        <dl id="menu-comments">
            ...
            <dd>
                <ul>
                    ...
                    <li><a data-href="zp_order" data-title="销售单" href="javascript:void(0)">赠品出库</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-member">
            ...
            <dd>
                <ul>
                    <li><a data-href="pur_orderl" data-title="用户管理" href="javascript:;">用户管理</a></li>
                    <li><a data-href="pur_order" data-title="用户管理" href="javascript:;">用户管理</a></li>
                    <li><a data-href="pur_order" data-title="用户管理" href="javascript:;">用户管理</a></li>
        ...
        <dl id="menu-admin">
            ...
            <dd>
                <ul>
                    <li><a data-href="pur_order" data-title="费用管理" href="javascript:void(0)">费用管理</a></li>
                    <li><a data-href="pur_order" data-title="费用管理" href="javascript:void(0)">费用管理</a></li>
                    <li><a data-href="pur_order" data-title="费用管理" href="javascript:void(0)">费用管理</a></li>
                </ul>
            </dd>
        ...
        <dl id="menu-tongji">
            <dt><i class="Hui-iconfont">&#xe61a;</i> 系统统计(待定)<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
            <dd>
                <ul>
                    <li><a data-href="pur_order" data-title="折线图" href="javascript:void(0)">折线图</a></li>
                    <li><a data-href="pur_order" data-title="时间轴折线图" href="javascript:void(0)">时间轴折线图</a></li>
                    <li><a data-href="pur_order" data-title="区域图" href="javascript:void(0)">区域图</a></li>
                    <li><a data-href="pur_order" data-title="柱状图" href="javascript:void(0)">柱状图</a></li>
                    <li><a data-href="pur_order" data-title="饼状图" href="javascript:void(0)">饼状图</a></li>
                    <li><a data-href="pur_order" data-title="3D柱状图" href="javascript:void(0)">3D柱状图</a></li>
                    <li><a data-href="pur_order" data-title="3D饼状图" href="javascript:void(0)">3D饼状图</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-system">
...
<section class="Hui-article-box">
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="pur_order"></iframe>
        </div>
    </div>
</section>
