...
@Entity
@Table(name = "f_con_s", schema = "dbo", catalog = "logistics")
...
public class FConSEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "f_con_s_s_con_billno", referencedColumnName = "f_con_m_s_con_billno", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "f_con_s_create_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "f_con_s_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "f_con_s_checker", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "f_con_s_group_node_id", referencedColumnName = "t_org_group_node_id",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "f_con_s_fee_no", referencedColumnName = "fee_class_fee_no",insertable = false, updatable = false)
