...
@Entity
@Table(name = "f_stock_adjus_m", schema = "dbo", catalog = "logistics_test")
public class FStockAdjusMEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "f_stock_adjus_m_warehouse_keeper", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "f_stock_adjus_m_creater_no", referencedColumnName = "t_staff_staff_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "f_stock_adjus_m_modifi_no", referencedColumnName = "t_staff_staff_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "f_stock_adjus_m_checker", referencedColumnName = "t_staff_staff_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "f_stock_adjus_m_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false)
