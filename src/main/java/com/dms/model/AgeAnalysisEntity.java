...
@Entity
@Table(name = "age_analysis", schema = "dbo", catalog = "logistics")
public class AgeAnalysisEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "age_analysis_group_node_id", referencedColumnName = "t_org_group_node_id",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "age_analysis_creater_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "age_analysis_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
