...
@Entity
@Table(name = "t_room", schema = "dbo", catalog = "logistics")
public class TRoomEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "t_room_create_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_room_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_room_group_node_id", referencedColumnName = "t_org_group_node_id",insertable = false, updatable = false)
