...
@Entity
@Table(name = "credit_level", schema = "dbo", catalog = "logistics_test")
public class CreditLevelEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "credit_level_group_node_id", referencedColumnName = "t_org_group_node_id")
    ...
    @ManyToOne
    @JoinColumn(name = "credit_level_creater_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "credit_level_modifi_no", referencedColumnName = "t_staff_staff_no")
