...
@Entity
@Table(name = "b_in_present_s", schema = "dbo", catalog = "logistics_test")
...
public class BInPresentSEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "b_in_present_s_in_present_no", referencedColumnName = "b_in_present_m_in_present_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_in_present_s_room_no", referencedColumnName = "store_location_location_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_in_present_s_room_no", referencedColumnName = "t_room_room_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_in_present_s_goods_no", referencedColumnName = "t_goods_goods_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_in_present_s_creater_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_in_present_s_modifi_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_in_present_s_checker", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_in_present_s_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false)
