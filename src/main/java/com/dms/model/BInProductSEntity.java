...
@Entity
@Table(name = "b_in_product_s", schema = "dbo", catalog = "logistics_test")
...
public class BInProductSEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "b_in_product_s_goods_no", referencedColumnName = "t_goods_goods_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_in_product_s_producStorage_no", referencedColumnName = "b_in_product_m_producStorage_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_in_product_s_creater_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_in_product_s_modifi_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_in_product_s_checker", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_in_product_s_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false)
