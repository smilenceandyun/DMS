...
@Entity
@Table(name = "b_s_order_s", schema = "dbo", catalog = "logistics")
...
public class BSOrderSEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_order_s_s_order_no", referencedColumnName = "b_s_order_m_s_order_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_order_s_goods_no", referencedColumnName = "t_goods_goods_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_order_s_s_con_billno", referencedColumnName = "b_s_con_m_s_con_billno",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_order_s_Promotion_no", referencedColumnName = "Promotion_m_Promotion_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_order_s_create_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_order_s_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_order_s_checker", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_order_s_location_no", referencedColumnName = "store_location_location_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_order_s_room_no", referencedColumnName = "t_room_room_no",insertable = false, updatable = false)
