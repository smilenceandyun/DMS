...
@Entity
@Table(name = "pay_type", schema = "dbo", catalog = "logistics_test")
public class PayTypeEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "pay_type_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "pay_type_creater_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "pay_type_modifi_no", referencedColumnName = "t_staff_staff_no")
