...
@Entity
@Table(name = "t_goods_classify", schema = "dbo", catalog = "logistics_test")
public class TGoodsClassifyEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "t_goods_classify_parent", referencedColumnName = "t_goods_classify_goods_classify_no")
    ...
    @ManyToOne
    @JoinColumn(name = "t_goods_classify_create_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "t_goods_classify_modifi_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "t_goods_classify_group_node_id", referencedColumnName = "t_org_group_node_id")
