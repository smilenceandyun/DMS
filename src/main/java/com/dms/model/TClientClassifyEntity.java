...
@Entity
@Table(name = "t_client_classify", schema = "dbo", catalog = "logistics_test")
public class TClientClassifyEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "t_client_classify_group_node_id", referencedColumnName = "t_org_group_node_id")
    ...
    @ManyToOne
    @JoinColumn(name = "t_client_classify_parent_id", referencedColumnName = "t_client_classify_client_classify_no")
    ...
    @ManyToOne
    @JoinColumn(name = "t_client_classify_create_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "t_client_classify_modifi_no", referencedColumnName = "t_staff_staff_no")
