...
@Entity
@Table(name = "encoding_type", schema = "dbo", catalog = "logistics_test")
public class EncodingTypeEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "encoding_type_group_node_id", referencedColumnName = "t_org_group_node_id")
    ...
    @ManyToOne
    @JoinColumn(name = "encoding_type_creater_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "encoding_type_modifi_no", referencedColumnName = "t_staff_staff_no")
