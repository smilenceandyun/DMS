...
@Entity
@Table(name = "t_route", schema = "dbo", catalog = "logistics")
public class TRouteEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "t_route_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_route_creater_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_route_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
