...
@Entity
@Table(name = "s_in_borrow_m", schema = "dbo", catalog = "logistics")
public class SInBorrowMEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_borrow_m_client_no", referencedColumnName = "t_client_client_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_borrow_m_salesman", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_borrow_m_warehouse_keeper", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_borrow_m_creater_no", referencedColumnName = "t_staff_staff_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_borrow_m_modifi_no", referencedColumnName = "t_staff_staff_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_borrow_m_checker", referencedColumnName = "t_staff_staff_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_borrow_m_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false,insertable = false, updatable = false)
