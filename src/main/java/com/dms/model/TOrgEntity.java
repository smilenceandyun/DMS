...
@Entity
@Table(name = "t_org", schema = "dbo", catalog = "logistics_test")
public class TOrgEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "t_org_create_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "t_org_modifi_no", referencedColumnName = "t_staff_staff_no")
