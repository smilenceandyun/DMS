...
@Entity
@Table(name = "b_sales_m", schema = "dbo", catalog = "logistics_test")
public class BSalesMEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "b_sales_m_s_order_no", referencedColumnName = "b_s_order_m_s_order_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_sales_m_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_sales_m_create_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_sales_m_modifi_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_sales_m_checker", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_sales_m_salesman", referencedColumnName = "t_staff_staff_no")
