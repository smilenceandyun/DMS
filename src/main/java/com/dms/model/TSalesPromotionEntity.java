...
@Entity
@Table(name = "t_sales_promotion", schema = "dbo", catalog = "logistics_test")
public class TSalesPromotionEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "t_sales_promotion_promotion_property_no", referencedColumnName = "promotion_property_promotion_property_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_sales_promotion_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_sales_promotion_create_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "t_sales_promotion_modifi_no", referencedColumnName = "t_staff_staff_no")
