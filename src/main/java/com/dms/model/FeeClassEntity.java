...
@Entity
@Table(name = "fee_class", schema = "dbo", catalog = "logistics_test")
public class FeeClassEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "fee_class_group_node_id", referencedColumnName = "t_org_group_node_id")
    ...
    @ManyToOne
    @JoinColumn(name = "fee_class_create_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "fee_class_modifi_no", referencedColumnName = "t_staff_staff_no")
