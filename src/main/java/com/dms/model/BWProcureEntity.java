...
@Entity
@Table(name = "b_w_procure", schema = "dbo", catalog = "logistics")
public class BWProcureEntity {
    ...
    @OneToOne
    @JoinColumn(name = "b_w_procure_r_procure_no", referencedColumnName = "b_r_procure_m_r_procure_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_w_procure_create_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_w_procure_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
