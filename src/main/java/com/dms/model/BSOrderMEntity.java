...
@Entity
@Table(name = "b_s_order_m", schema = "dbo", catalog = "logistics_test")
public class BSOrderMEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_order_m_client_no", referencedColumnName = "t_client_client_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_order_m_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_order_m_salesman", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_order_m_sales_type_no", referencedColumnName = "sales_properties_sales_type_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_order_m_checker", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_order_m_modifi_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_order_m_create_no", referencedColumnName = "t_staff_staff_no")
