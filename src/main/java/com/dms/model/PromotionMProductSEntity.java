...
@Entity
@Table(name = "Promotion_m_product_s", schema = "dbo", catalog = "logistics_test")
...
public class PromotionMProductSEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "Promotion_m_product_s_Promotion_no", referencedColumnName = "Promotion_m_Promotion_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "Promotion_m_product_s_goods_no", referencedColumnName = "t_goods_goods_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "Promotion_m_product_s_location_no", referencedColumnName = "store_location_location_no")
    ...
    @ManyToOne
    @JoinColumn(name = "Promotion_m_product_s_sales_promotion_no", referencedColumnName = "t_sales_promotion_sales_promotion_no")
    ...
    @ManyToOne
    @JoinColumn(name = "Promotion_m_product_s_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "Promotion_m_product_s_client_no", referencedColumnName = "t_client_client_no")
    ...
    @ManyToOne
    @JoinColumn(name = "Promotion_m_product_s_checker", referencedColumnName = "t_staff_staff_no")
