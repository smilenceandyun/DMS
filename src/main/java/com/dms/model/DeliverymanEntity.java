...
@Entity
@Table(name = "deliveryman", schema = "dbo", catalog = "logistics")
public class DeliverymanEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "deliveryman_create_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "deliveryman_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "deliveryman_group_node_id", referencedColumnName = "t_org_group_node_id",insertable = false, updatable = false)
