...
@Entity
@Table(name = "b_agent_instock_m", schema = "dbo", catalog = "logistics")
public class BAgentInstockMEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_instock_m_ord_procure_no", referencedColumnName = "b_purchase_ord_m_ord_procure_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_instock_m_creater_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_instock_m_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_instock_m_checker", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_instock_m_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false,insertable = false, updatable = false)
