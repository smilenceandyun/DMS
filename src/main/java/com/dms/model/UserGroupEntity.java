...
@Entity
@Table(name = "user_group", schema = "dbo", catalog = "logistics")
public class UserGroupEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "user_group_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "user_group_creater_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "user_group_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
