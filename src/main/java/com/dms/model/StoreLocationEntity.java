...
@Entity
@Table(name = "store_location", schema = "dbo", catalog = "logistics")
public class StoreLocationEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "store_location_room_no", referencedColumnName = "t_room_room_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "store_location_create_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "store_location_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "store_location_group_node_id", referencedColumnName = "t_org_group_node_id",insertable = false, updatable = false)
