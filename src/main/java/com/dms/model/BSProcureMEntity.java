...
@Entity
@Table(name = "b_s_procure_m", schema = "dbo", catalog = "logistics")
public class BSProcureMEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_procure_m_sales_no", referencedColumnName = "b_sales_m_sales_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_procure_m_s_order_no", referencedColumnName = "b_s_order_m_s_order_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_procure_m_salesman", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_procure_m_create_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_procure_m_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_procure_m_checker", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_procure_m_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false,insertable = false, updatable = false)
