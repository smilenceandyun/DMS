...
@Entity
@Table(name = "s_out_loan_m", schema = "dbo", catalog = "logistics_test")
public class SOutLoanMEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "s_out_loan_m_client_no", referencedColumnName = "t_client_client_no")
    ...
    @ManyToOne
    @JoinColumn(name = "s_out_loan_m_payment_no", referencedColumnName = "t_payment_payment_no")
    ...
    @ManyToOne
    @JoinColumn(name = "s_out_loan_m_salesman", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "s_out_loan_m_warehouse_keeper", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "s_out_loan_m_creater_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "s_out_loan_m_modifi_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "s_out_loan_m_checker", referencedColumnName = "t_staff_staff_no")
