...
@Entity
@Table(name = "s_room_transfer_s", schema = "dbo", catalog = "logistics")
...
public class SRoomTransferSEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "s_room_transfer_s_room_transfer_no", referencedColumnName = "s_room_transfer_m_room_transfer_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_room_transfer_s_out_room_no", referencedColumnName = "t_room_room_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_room_transfer_s_out_location_no", referencedColumnName = "store_location_location_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_room_transfer_s_in_room_no", referencedColumnName = "t_room_room_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_room_transfer_s_in_location_no", referencedColumnName = "store_location_location_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_room_transfer_s_creater_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_room_transfer_s_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_room_transfer_s_checker", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
