...
@Entity
@Table(name = "salesman_group", schema = "dbo", catalog = "logistics")
public class SalesmanGroupEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "salesman_group_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "salesman_group_creater_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "salesman_group_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
