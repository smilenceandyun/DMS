...
@Entity
@Table(name = "bank_account", schema = "dbo", catalog = "logistics")
public class BankAccountEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "bank_account_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "bank_account_creater_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "bank_account_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
