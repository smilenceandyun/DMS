...
@Entity
@Table(name = "t_client", schema = "dbo", catalog = "logistics_test")
public class TClientEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "t_client_parent_id", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "t_client_client_classify_no", referencedColumnName = "t_client_classify_client_classify_no")
    ...
    @ManyToOne
    @JoinColumn(name = "t_client_client_zone_no", referencedColumnName = "client_zone_client_zone_no")
    ...
    @ManyToOne
    @JoinColumn(name = "t_client_create_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "t_client_group_node_id", referencedColumnName = "t_org_group_node_id")
