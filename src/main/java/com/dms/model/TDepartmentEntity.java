...
@Entity
@Table(name = "t_department", schema = "dbo", catalog = "logistics")
public class TDepartmentEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "t_department_group_node_id", referencedColumnName = "t_org_group_node_id",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_department_create_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_department_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
