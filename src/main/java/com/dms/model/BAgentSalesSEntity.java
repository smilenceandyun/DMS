...
@Entity
@Table(name = "b_agent_sales_s", schema = "dbo", catalog = "logistics")
...
public class BAgentSalesSEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_sales_s_agent_sales_no", referencedColumnName = "b_agent_sales_m_agent_sales_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_sales_s_room_no", referencedColumnName = "store_location_location_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_sales_s_goods_no", referencedColumnName = "t_goods_goods_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_sales_s_creater_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_sales_s_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_sales_s_checker", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_sales_s_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false,insertable = false, updatable = false)
