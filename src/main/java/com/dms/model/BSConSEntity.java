...
@Entity
@Table(name = "b_s_con_s", schema = "dbo", catalog = "logistics_test")
...
public class BSConSEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_con_s_s_con_billno", referencedColumnName = "b_s_con_m_s_con_billno", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_con_s_goods_no", referencedColumnName = "t_goods_goods_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_con_s_payment_no", referencedColumnName = "t_payment_payment_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_con_s_create_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_con_s_modifi_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_con_s_checker", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_s_con_s_group_node_id", referencedColumnName = "t_org_group_node_id")
