...
@Entity
@Table(name = "b_agent_rsales_s", schema = "dbo", catalog = "logistics_test")
...
public class BAgentRsalesSEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_rsales_s_agent_rsales_no", referencedColumnName = "b_agent_rsales_m_agent_rsales_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_rsales_s_agent_rsales_no", referencedColumnName = "b_agent_sales_m_agent_sales_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_rsales_s_room_no", referencedColumnName = "store_location_location_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_rsales_s_location_no", referencedColumnName = "store_location_location_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_rsales_s_payment_no", referencedColumnName = "t_payment_payment_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_rsales_s_creater_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_rsales_s_modifi_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_rsales_s_checker", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_rsales_s_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false)
