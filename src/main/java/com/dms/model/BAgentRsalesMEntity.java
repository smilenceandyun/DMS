...
@Entity
@Table(name = "b_agent_rsales_m", schema = "dbo", catalog = "logistics_test")
public class BAgentRsalesMEntity {
    ...
    @OneToOne
    @JoinColumn(name = "b_agent_rsales_m_agent_rsales_no", referencedColumnName = "b_agent_sales_m_agent_sales_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_rsales_m_creater_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_rsales_m_modifi_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_rsales_m_checker", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_rsales_m_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_rsales_m_warehouse_keeper", referencedColumnName = "t_staff_staff_no")
