...
@Entity
@Table(name = "t_car", schema = "dbo", catalog = "logistics")
public class TCarEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "t_car_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_car_creater_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_car_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
