...
@Entity
@Table(name = "b_agent_instock_s", schema = "dbo", catalog = "logistics")
...
public class BAgentInstockSEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_instock_s_agent_instock_no", referencedColumnName = "b_agent_instock_m_agent_instock_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_instock_s_room_no", referencedColumnName = "store_location_location_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_instock_s_goods_no", referencedColumnName = "t_goods_goods_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_instock_s_creater_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_instock_s_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_instock_s_checker", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_agent_instock_s_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false,insertable = false, updatable = false)
