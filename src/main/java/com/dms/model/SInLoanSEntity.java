...
@Entity
@Table(name = "s_in_loan_s", schema = "dbo", catalog = "logistics")
...
public class SInLoanSEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_loan_s_in_loan_lno", referencedColumnName = "s_in_loan_m_in_loan_lno", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_loan_s_room_no", referencedColumnName = "t_room_room_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_loan_s_location_no", referencedColumnName = "store_location_location_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_loan_s_creater_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_loan_s_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_loan_s_checker", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_loan_s_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false,insertable = false, updatable = false)
