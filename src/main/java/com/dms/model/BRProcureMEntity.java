...
@Entity
@Table(name = "b_r_procure_m", schema = "dbo", catalog = "logistics")
public class BRProcureMEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "b_r_procure_m_salesman", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_r_procure_m_warehouse_keeper", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_r_procure_m_deliveryman_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_r_procure_m_group_node_id", referencedColumnName = "t_org_group_node_id",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_r_procure_m_create_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_r_procure_m_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_r_procure_m_checker", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
