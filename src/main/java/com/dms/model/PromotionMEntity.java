...
@Entity
@Table(name = "Promotion_m", schema = "dbo", catalog = "logistics_test")
public class PromotionMEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "Promotion_m_salesman", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "Promotion_m_create_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "Promotion_m_modifi_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "Promotion_m_checker", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "Promotion_m_group_node_id", referencedColumnName = "t_org_group_node_id")
