...
@Entity
@Table(name = "client_zone", schema = "dbo", catalog = "logistics_test")
public class ClientZoneEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "client_zone_group_node_id", referencedColumnName = "t_org_group_node_id")
    ...
    @ManyToOne
    @JoinColumn(name = "client_zone_create_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "client_zone_modifi_no", referencedColumnName = "t_staff_staff_no")
