...
@Entity
@Table(name = "c_purchase_con_s", schema = "dbo", catalog = "logistics_test")
...
public class CPurchaseConSEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "c_purchase_con_s_manager_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "c_purchase_con_s_create_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "c_purchase_con_s_modifi_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "c_purchase_con_s_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "c_purchase_con_s_client_no", referencedColumnName = "t_client_client_no")
    ...
    @ManyToOne
    @JoinColumn(name = "c_purchase_con_s_payment_no", referencedColumnName = "t_payment_payment_no")
    ...
    @ManyToOne
    @JoinColumn(name = "c_purchase_con_s_goods_no", referencedColumnName = "t_goods_goods_no")
    ...
    @ManyToOne
    @JoinColumn(name = "c_purchase_con_s_checker", referencedColumnName = "t_staff_staff_no")
