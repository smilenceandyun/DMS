...
@Entity
@Table(name = "f_con_m", schema = "dbo", catalog = "logistics")
public class FConMEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "f_con_m_client_no", referencedColumnName = "t_client_client_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "f_con_m_create_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "f_con_m_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "f_con_m_checker", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "f_con_m_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false,insertable = false, updatable = false)
