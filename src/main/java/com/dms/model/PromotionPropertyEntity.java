...
@Entity
@Table(name = "promotion_property", schema = "dbo", catalog = "logistics_test")
public class PromotionPropertyEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "promotion_property_group_node_id", referencedColumnName = "t_org_group_node_id")
    ...
    @ManyToOne
    @JoinColumn(name = "promotion_property_create_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "promotion_property_modifi_no", referencedColumnName = "t_staff_staff_no")
