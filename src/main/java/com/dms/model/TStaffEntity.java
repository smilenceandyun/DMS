...
@Entity
@Table(name = "t_staff", schema = "dbo", catalog = "logistics")
public class TStaffEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "t_staff_group_node_id", referencedColumnName = "t_org_group_node_id",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_staff_dept_no", referencedColumnName = "t_department_dept_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_staff_potition_no", referencedColumnName = "t_position_potition_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_staff_create_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_staff_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
