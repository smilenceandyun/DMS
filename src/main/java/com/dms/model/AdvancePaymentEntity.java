...
@Entity
@Table(name = "advance_payment", schema = "dbo", catalog = "logistics")
public class AdvancePaymentEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "advance_payment_t_s_staff_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "advance_payment_group_node_id", referencedColumnName = "t_org_group_node_id",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "advance_payment_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
