...
@Entity
@Table(name = "DistributionList", schema = "dbo", catalog = "logistics")
public class DistributionListEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "DistributionList_car_no", referencedColumnName = "t_car_car_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "DistributionList_deliveryman_no", referencedColumnName = "deliveryman_deliveryman_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "DistributionList_client_no", referencedColumnName = "t_client_client_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "DistributionList_creater_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "DistributionList_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "DistributionList_checker", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "DistributionList_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false,insertable = false, updatable = false)
