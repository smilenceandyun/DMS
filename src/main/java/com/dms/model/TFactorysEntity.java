...
@Entity
@Table(name = "t_factorys", schema = "dbo", catalog = "logistics")
public class TFactorysEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "t_factorys_create_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_factorys_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_factorys_group_node_id", referencedColumnName = "t_org_group_node_id",insertable = false, updatable = false)
