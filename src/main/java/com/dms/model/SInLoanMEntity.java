...
@Entity
@Table(name = "s_in_loan_m", schema = "dbo", catalog = "logistics_test")
public class SInLoanMEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_loan_m_out_loan_no", referencedColumnName = "s_out_loan_m_out_loan_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_loan_m_salesman", referencedColumnName = "t_staff_staff_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_loan_m_warehouse_keeper", referencedColumnName = "t_staff_staff_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_loan_m_creater_no", referencedColumnName = "t_staff_staff_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_loan_m_modifi_no", referencedColumnName = "t_staff_staff_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_loan_m_checker", referencedColumnName = "t_staff_staff_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_loan_m_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false)
