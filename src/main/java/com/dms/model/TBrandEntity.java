...
@Entity
@Table(name = "t_brand", schema = "dbo", catalog = "logistics")
public class TBrandEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "t_brand_group_node_id", referencedColumnName = "t_org_group_node_id",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_brand_create_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_brand_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
