...
@Entity
@Table(name = "Promotion_p_group", schema = "dbo", catalog = "logistics_test")
public class PromotionPGroupEntity {
    ...
    @OneToOne
    @JoinColumn(name = "Promotion_p_group_Promotion_no", referencedColumnName = "Promotion_m_Promotion_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "Promotion_p_group_goods_no", referencedColumnName = "t_goods_goods_no")
