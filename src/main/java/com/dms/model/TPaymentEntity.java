...
@Entity
@Table(name = "t_payment", schema = "dbo", catalog = "logistics")
public class TPaymentEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "t_payment_create_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_payment_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_payment_group_node_id", referencedColumnName = "t_org_group_node_id",insertable = false, updatable = false)
