...
@Entity
@Table(name = "b_procure_m", schema = "dbo", catalog = "logistics")
public class BProcureMEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "b_procure_m_ord_procure_no", referencedColumnName = "b_purchase_ord_m_ord_procure_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_procure_m_warehouse_kep", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_procure_m_create_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_procure_m_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_procure_m_checker", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_procure_m_group_node_id", referencedColumnName = "t_org_group_node_id",insertable = false, updatable = false)
