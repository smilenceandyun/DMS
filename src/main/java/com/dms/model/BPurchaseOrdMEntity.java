...
@Entity
@Table(name = "b_purchase_ord_m", schema = "dbo", catalog = "logistics_test")
public class BPurchaseOrdMEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "b_purchase_ord_m_client_no", referencedColumnName = "t_client_client_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_purchase_ord_m_factory_goods_no", referencedColumnName = "t_factorys_factory_goods_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_purchase_ord_m_salesman", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_purchase_ord_m_create_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_purchase_ord_m_modifi_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_purchase_ord_m_checker", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_purchase_ord_m_manager_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_purchase_ord_m_group_node_id", referencedColumnName = "t_org_group_node_id")
