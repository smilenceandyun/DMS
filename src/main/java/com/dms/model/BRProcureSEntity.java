...
@Entity
@Table(name = "b_r_procure_s", schema = "dbo", catalog = "logistics_test")
...
public class BRProcureSEntity {
    ...
    @ManyToOne
    @JoinColumns({@JoinColumn(name = "b_r_procure_s_ord_procure_no", referencedColumnName = "b_purchase_ord_s_ord_procure_no",nullable = false), @JoinColumn(name = "b_r_procure_s_detail_id", referencedColumnName = "b_purchase_ord_s_detail_id", nullable = false)})
    ...
    @ManyToOne
    @JoinColumn(name = "b_r_procure_s_create_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_r_procure_s_modifi_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_r_procure_s_checker", referencedColumnName = "t_staff_staff_no")
