...
@Entity
@Table(name = "t_goods", schema = "dbo", catalog = "logistics")
public class TGoodsEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "t_goods_goods_classify_no", referencedColumnName = "t_goods_classify_goods_classify_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_goods_brand_no", referencedColumnName = "t_brand_brand_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_goods_factory_goods_no", referencedColumnName = "t_factorys_factory_goods_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_goods_create_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_goods_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_goods_group_node_id", referencedColumnName = "t_org_group_node_id",insertable = false, updatable = false)
