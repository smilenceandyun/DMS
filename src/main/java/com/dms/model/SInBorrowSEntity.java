...
@Entity
@Table(name = "s_in_borrow_s", schema = "dbo", catalog = "logistics_test")
public class SInBorrowSEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_borrow_s_room_no", referencedColumnName = "t_room_room_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_borrow_s_location_no", referencedColumnName = "store_location_location_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_borrow_s_goods_no", referencedColumnName = "t_goods_goods_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_borrow_s_creater_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_borrow_s_modifi_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "s_in_borrow_s_checker", referencedColumnName = "t_staff_staff_no")
