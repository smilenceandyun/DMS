...
@Entity
@Table(name = "Promotion_m_s", schema = "dbo", catalog = "logistics_test")
...
public class PromotionMSEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "Promotion_m_s_group_node_id", referencedColumnName = "t_org_group_node_id")
    ...
    @ManyToOne
    @JoinColumn(name = "Promotion_m_s_create_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "Promotion_m_s_modifi_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "Promotion_m_s_checker", referencedColumnName = "t_staff_staff_no")
