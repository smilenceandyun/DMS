...
@Entity
@Table(name = "t_position", schema = "dbo", catalog = "logistics")
public class TPositionEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "t_position_group_node_id", referencedColumnName = "t_org_group_node_id",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_position_create_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_position_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
