...
@Entity
@Table(name = "t_present", schema = "dbo", catalog = "logistics")
public class TPresentEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "t_present_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_present_creater_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "t_present_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
