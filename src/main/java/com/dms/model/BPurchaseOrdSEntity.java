...
@Entity
@Table(name = "b_purchase_ord_s", schema = "dbo", catalog = "logistics_test")
...
public class BPurchaseOrdSEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "b_purchase_ord_s_location_no", referencedColumnName = "store_location_location_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_purchase_ord_s_room_no", referencedColumnName = "t_room_room_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_purchase_ord_s_goods_no", referencedColumnName = "t_goods_goods_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_purchase_ord_s_payment_no", referencedColumnName = "t_payment_payment_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_purchase_ord_s_purchas_con_no", referencedColumnName = "c_purchase_con_m_purchas_con_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_purchase_ord_s_create_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_purchase_ord_s_modifi_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_purchase_ord_s_group_node_id", referencedColumnName = "t_org_group_node_id")
    ...
    @ManyToOne
    @JoinColumn(name = "b_purchase_ord_s_factory_goods_no", referencedColumnName = "t_factorys_factory_goods_no")
    ...
    @ManyToOne
    @JoinColumn(name = "b_purchase_ord_s_checker", referencedColumnName = "t_staff_staff_no")
