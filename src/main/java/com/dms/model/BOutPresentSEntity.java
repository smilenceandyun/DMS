...
@Entity
@Table(name = "b_out_present_s", schema = "dbo", catalog = "logistics")
...
public class BOutPresentSEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "b_out_present_s_out_present_no", referencedColumnName = "b_out_present_m_out_present_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_out_present_s_location_no", referencedColumnName = "store_location_location_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_out_present_s_goods_no", referencedColumnName = "t_goods_goods_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_out_present_s_main_goods_no", referencedColumnName = "t_goods_goods_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_out_present_s_create_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_out_present_s_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_out_present_s_checker", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_out_present_s_group_node_id", referencedColumnName = "t_org_group_node_id",insertable = false, updatable = false)
