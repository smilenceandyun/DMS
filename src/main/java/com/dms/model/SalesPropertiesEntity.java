...
@Entity
@Table(name = "sales_properties", schema = "dbo", catalog = "logistics_test")
public class SalesPropertiesEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "sales_properties_group_node_id", referencedColumnName = "t_org_group_node_id")
    ...
    @ManyToOne
    @JoinColumn(name = "sales_properties_create_no", referencedColumnName = "t_staff_staff_no")
    ...
    @ManyToOne
    @JoinColumn(name = "sales_properties_modifi_no", referencedColumnName = "t_staff_staff_no")
