...
@Entity
@Table(name = "b_out_present_m", schema = "dbo", catalog = "logistics")
public class BOutPresentMEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "b_out_present_m_create_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_out_present_m_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_out_present_m_checker", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_out_present_m_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_out_present_m_s_order_no", referencedColumnName = "b_s_order_m_s_order_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_out_present_m_warehouse_keeper", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "b_out_present_m_deliveryman_no", referencedColumnName = "deliveryman_deliveryman_no",insertable = false, updatable = false)
