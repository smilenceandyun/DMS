...
@Entity
@Table(name = "Promotion_client_group", schema = "dbo", catalog = "logistics_test")
...
public class PromotionClientGroupEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "Promotion_client_group_Promotion_no", referencedColumnName = "Promotion_m_Promotion_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "Promotion_client_group_client_no", referencedColumnName = "t_client_client_no", nullable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "Promotion_client_group_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false)
