...
@Entity
@Table(name = "f_stock_adjus_s", schema = "dbo", catalog = "logistics")
...
public class FStockAdjusSEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "f_stock_adjus_s_room_no", referencedColumnName = "t_room_room_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "f_stock_adjus_s_location_no", referencedColumnName = "store_location_location_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "f_stock_adjus_s_goods_no", referencedColumnName = "t_goods_goods_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "f_stock_adjus_s_creater_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "f_stock_adjus_s_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "f_stock_adjus_s_checker", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
