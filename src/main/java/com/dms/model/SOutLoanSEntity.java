...
@Entity
@Table(name = "s_out_loan_s", schema = "dbo", catalog = "logistics")
...
public class SOutLoanSEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "s_out_loan_s_out_loan_no", referencedColumnName = "s_out_loan_m_out_loan_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_out_loan_s_goods_no", referencedColumnName = "t_goods_goods_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_out_loan_s_room_no", referencedColumnName = "t_room_room_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_out_loan_s_location_no", referencedColumnName = "store_location_location_no", nullable = false,insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_out_loan_s_creater_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_out_loan_s_modifi_no", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_out_loan_s_checker", referencedColumnName = "t_staff_staff_no",insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "s_out_loan_s_group_node_id", referencedColumnName = "t_org_group_node_id", nullable = false,insertable = false, updatable = false)
